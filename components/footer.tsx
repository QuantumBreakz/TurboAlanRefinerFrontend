    ...
    <footer className="bg-background border-t border-border mt-8 md:mt-16">
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-8 md:py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
          ...
          <div className="space-y-3 md:space-y-4">
            <div className="flex items-center space-x-2">
              <div className="w-7 h-7 md:w-8 md:h-8 bg-primary rounded-lg flex items-center justify-center">
                <span className="text-primary-foreground font-bold text-base md:text-lg">TA</span>
              </div>
              <span className="text-foreground font-semibold text-base md:text-lg">Turbo Alan</span>
            </div>
          ...
          {/* Product */}
          <div className="space-y-3 md:space-y-4">
            <h3 className="text-foreground font-semibold text-sm md:text-base">Product</h3>
          ...
          {/* Support */}
          <div className="space-y-3 md:space-y-4">
            <h3 className="text-foreground font-semibold text-sm md:text-base">Support</h3>
            <ul className="space-y-2 text-xs md:text-sm">
              <li>
          ...
          {/* Company */}
          <div className="space-y-3 md:space-y-4">
            <h3 className="text-foreground font-semibold text-sm md:text-base">Company</h3>
            <ul className="space-y-2 text-xs md:text-sm">
              <li>
        ...
        <div className="border-t border-border mt-6 md:mt-8 pt-6 md:pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-muted-foreground text-xs md:text-sm text-center md:text-left">© 2024 Turbo Alan Refiner. All rights reserved.</p>
