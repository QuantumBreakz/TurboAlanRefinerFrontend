          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-sm">
              <div className="p-3 bg-purple-50 border border-purple-200 rounded">
                ...
                <div className="text-lg font-bold text-purple-800">{data.schema_usage.total_usages}</div>
              ...
              <div className="p-3 bg-indigo-50 border border-indigo-200 rounded">
                ...
                <div className="text-xs text-indigo-600">
                  {data.schema_usage.most_used_count} times
                </div>
              </div>
              <div className="p-3 bg-pink-50 border border-pink-200 rounded">
                ...
                <div className="text-xs text-pink-600">
                  {data.schema_usage.least_used_count} times
                </div>
              </div>
              <div className="p-3 bg-teal-50 border border-teal-200 rounded">
                ...
                <div className="text-lg font-bold text-teal-800">
                  {data.schema_usage.average_usage.toFixed(1)}
                </div>
